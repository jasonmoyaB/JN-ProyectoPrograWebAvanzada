...
namespace JN_ProyectoPrograAvanzadaWeb_G1.Application.Services
{
    public class SolicitudService : ISolicitudService
    {
        ...
        {
            // Por ahora retornamos 1, pero esto debería obtenerse de la base de datos
            // En una implementación completa, deberías tener un repositorio de EstadosSolicitud
            return 1; // Asumiendo que el estado Pendiente tiene ID = 1
        }
    }
}
